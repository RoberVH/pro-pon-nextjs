    ...
    return (
      <div>
        ...
        disabled={actionButtonClicked}
          className="mr-1 inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-1 bg-blue-500 text-sm 
  ...
  return (
      <div >
        <div className=" flex justify-center items-center  mb-4">
          ...
          <button
            disabled={actionButtonClicked}
            className="mt-24 mr-4 rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-500 text-sm disabled:bg-red-600
