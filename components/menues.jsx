...
const Menues = forwardRef (({isVisible}, ref) =>  {
  ...
  return (
    <div ref={ref} className='flex mt-12 ml-20' >
      <div className="text-white text-base font-semibold font-khula uppercase flex items-start mr-8">
          <label 
      ...
      <div className="text-white text-base font-semibold font-khula  uppercase flex items-start">
          <label 
