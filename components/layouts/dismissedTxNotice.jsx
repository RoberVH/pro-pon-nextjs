...
const DismissedTxNotice = ({notification, buttonText, setNoticeOff, dropTx, typeTx}) => 
    <div className="absolute top-[30%] left-[40%] rounded-md shadow-md w-[40%] h-auto  border-2
    border-orange-500  flex flex-col justify-start bg-stone-100">
        {console.log('dropTx', dropTx)}
