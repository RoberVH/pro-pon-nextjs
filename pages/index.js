    ...
    <div className="w-full py-16  bg-gradient-to-r from-blue-300 via-orange-200 to-blue-300">
      <div className="font-khula text-stone-800  grid grid-cols-2 grid-gap-16">
        ...
        <ul> 
            ...
            <li> ‣ &nbsp; A story of past performance is trackable giving you certainty on providers</li>
      ...
      <div className="grid grid-cols-2 gap-4 text-stone-200 font-khula text-2xl">
        <div className="mt-16" >
          <div className="flex pt-16 pl-40">
            <Image alt='logo' src='/pro-ponLogo.png'  width={65} height={20}></Image>
              <h1 className="ml-2 mt-4 mb-4 bg-gradient-to-r from-[#084da1] to-[#d93f0b] 
        ...
        <div className="grid grid-cols-2 gap-1">
            <div className="leading-12 pt-8 pr-8 text-start">
              <p className="text-3xl pb-8"><strong>Porqué Pro-pon</strong></p>
              <Link href="/" passHref className="mt-8"><p className="cursor-pointer">Legal</p></Link>
              <Link href="/" passHref className="mt-4"><p className="cursor-pointer">Documentos</p></Link>
            </div>
            <div className="leading-12 pt-8 pr-8 text-start">
              <p className="text-3xl pb-8"><strong>Como usarlo </strong></p>
                <Link href="/" passHref className="mt-8"><p className="cursor-pointer">Guia</p></Link>
              <Link href="/" passHref className="mt-4"><p className="cursor-pointer">Videos</p></Link> 
            </div>
        </div>
      </div>
