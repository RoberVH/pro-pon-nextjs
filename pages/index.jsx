...
function LandingPage() {
  ...
  const InfoCard = ({ title, image, info, styleObject }) => (
    <li>
      <div
        className="space-y-4 p-4 h-full  rounded-lg"
      ...
      >
        <div className=" flex items-center aspect-w-3 aspect-h-2 ">
          ...
          <p
            className="ml-4 mt-5 sm:text-lg md:text-lg lg:text-xl xl:text-xl text-stone-800"
  ...
  const CTA_Card = () => (
    ...
    >
      <p
        className=" sm:mt-2 lg:mt-4 font-inter text-center sm:text-md md:text-lg lg:text-xl xl:text-xl font-semibold
  ...
  return (
    ...
    >
      ...
      <div id="main-section" className="pt-2">
        <div
          id="page-header"
          className="mx-auto max-w-9xl px-4 sm:mt-16 lg:mt-24 text-center"
        >
        ...
        <div className="flex justify-center mb-8 ">
          <div className="flex text-[#0B3A71] text-xl font-semibold pb-4 ">
            <p>&nbsp;</p>
            <p className="py-1 px-2 tracking-wide ">{t("ap_title3")}</p>
          </div>
        </div>

        <div
          id="page-subheader"
          className="mt-32 w-[80%] mx-auto flex items-stretch border-[1px] border-slate-500 rounded-lg shadow-lg py-8 px-16"
        >
          <div className="flex-col">
            <Image
              className="object-cover rounded-2xl opacity-90"
              src={"/3 1 Propon blockchain.png"}
              priority
              height={1400}
              width={1600}
              alt="blockchainnodes"
          ...
          <div className="flex mt-72">
            <div className=" font-inter  flex justify-center items-center ">
              <div className=" flex justify-end pr-10">
                <p
                  className="w-[60%] font-inter text-right italic
        ...
        <div
          ...
          className="sm:my-16 md:my-18 lg:my-24 xl:my-24  py-8"
        >
        ...
        <div
          id="featherImg"
          className="absolut mt-16 flex justify-left py-16  bg-repeat "
        ...
        <div
          id="CTA-subsection"
          className="sm:mb-16 md:mb-18 lg:mb-24 xl:mb-48"
          style={{
            boxShadow:
        ...
        <div className="w-[70%] mx-auto">
          <div
            id="no-signup-notice"
            className=" text-center p-4 bg-gradient-to-r from-orange-300 via-red-500 to-orange-300
            rounded-md"
      ...
      >
        ...
        >
          <div className="w-[50%] mr-32 ">
            <p
              className=" mb-8 sm:text-lg  md:text-xl lg:text-3xl xl:text-3xl font-semibold text-blue-800"
      ...
      <div
        ...
        className="px-16 pt-16 sm:pb-32 md:pb-32 lg:pb-48 xl:pb-48 "
      >
        <div className="flex justify-center">
          <p
            className="mt-12 lg:text-3xl xl:text-4xl md:text-2xl sm:text-xl text-orange-500 font-bold tracking-wider
